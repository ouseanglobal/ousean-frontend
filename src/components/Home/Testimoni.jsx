...
export default function Testimoni() {
  return (
    <section className="mb-40">
      <h1 className="mx-auto mb-5 items-center justify-center text-center text-3xl font-bold text-slate-700">
        Testimoni Ousean
      </h1>
      <div className="justify-center overflow-hidden px-3 sm:flex sm:flex-wrap md:flex lg:flex lg:px-0">
        <div className="font-Intern  relative mb-7 mt-7 rounded-xl bg-testimoni p-5 shadow-lg sm:mx-5 sm:h-80 sm:w-96 md:h-96 md:w-96 lg:w-96">
          <Link href="">
            <a>
        ...
        <div className="font-Intern mb-7 mt-7 rounded-xl bg-testimoni p-5 shadow-lg sm:mx-5 sm:h-80 sm:w-96 md:h-96 md:w-96 lg:w-96">
          <span className="float-left px-3 ">
            <Image
